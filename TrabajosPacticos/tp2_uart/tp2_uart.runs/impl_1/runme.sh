...
HD_PWD='C:/Users/Laudi/vivado_projects/ArquiComp2021/TrabajosPacticos/tp2_uart/tp2_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BaudRateGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BaudRateGenerator.tcl -notrace
