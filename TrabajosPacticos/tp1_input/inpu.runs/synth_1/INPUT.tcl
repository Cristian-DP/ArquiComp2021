...
synth_design -top INPUT -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef INPUT.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file INPUT_utilization_synth.rpt -pb INPUT_utilization_synth.pb"
