...
REM
REM Generated by Vivado on Thu Nov 18 13:57:45 -0300 2021
...
echo "xvlog --incr --relax -prj test_interface_Rx_vlog.prj"
call xvlog  --incr --relax -prj test_interface_Rx_vlog.prj -log xvlog.log
