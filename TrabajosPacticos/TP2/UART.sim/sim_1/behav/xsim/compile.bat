...
REM
REM Generated by Vivado on Thu Nov 04 12:08:46 -0300 2021
...
echo "xvlog --incr --relax -prj testRxUart_vlog.prj"
call xvlog  --incr --relax -prj testRxUart_vlog.prj -log xvlog.log
