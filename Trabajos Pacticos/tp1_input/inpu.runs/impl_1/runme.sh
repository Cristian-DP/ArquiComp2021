...
HD_PWD='C:/Users/Laudi/vivado_projects/ArquiComp2021/Trabajos Pacticos/tp1_input/inpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log INPUT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source INPUT.tcl -notrace
