...
HD_PWD='C:/Users/Laudi/vivado_projects/ArquiComp2021/Trabajos Pacticos/tp1_input/inpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log INPUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source INPUT.tcl
